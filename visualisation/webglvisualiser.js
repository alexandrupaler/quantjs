...
function WebGLVisualiser() {
    ...
    /*
        Injection point representations
    */
...
*/
WebGLVisualiser.prototype.readGetParameters = function () {
    var GET = {};
...
WebGLVisualiser.prototype.deleteAllSceneRelated = function () {
    this.container.innerHTML = "";
    this.scene = null;
}

// ************ STARTUP *****************
WebGLVisualiser.prototype.start_defect_view = function (gr1, gr2, gr3, gr4, bx0) {
...
WebGLVisualiser.prototype.addSphere = function (x, y, z, material) {
...
WebGLVisualiser.prototype.removeAllSpheres = function () {
...
WebGLVisualiser.prototype.add_edge2 = function (x1, y1, z1, x2, y2, z2, lineSegmentsGeometry) {
...
WebGLVisualiser.prototype.add_edge2Index = function (index, graphobject, lineSegmentsGeometry) {
...
WebGLVisualiser.prototype.makePins = function (boxparam, bigcube) {
...
WebGLVisualiser.prototype.makeBoxes = function (sched) {
...
WebGLVisualiser.prototype.debugMessage = function (message, x, y, z) {
...
WebGLVisualiser.prototype.findPoint = function (point, graphobject, objToFill) {
    //make edges
    var found = false;
    var i = -1;
...
WebGLVisualiser.prototype.makeGeometry = function (graphobject, objToFill) {
...
WebGLVisualiser.prototype.setup_visualisation = function (containername) {
...
WebGLVisualiser.prototype.pre_init = function () {
...
WebGLVisualiser.prototype.updateBoundingBox = function (cw, ch, cd) {
    if (cw < this.bBox[0])
        this.bBox[0] = cw;
...
WebGLVisualiser.prototype.resetBoundingBox = function () {
...
WebGLVisualiser.prototype.makeBoundingBox = function () {
...
WebGLVisualiser.prototype.mouse3dray = function (x, y) {
...
*/
WebGLVisualiser.prototype.makeLineSegments = function (arrBuffered, material) {
...
WebGLVisualiser.prototype.makeBuffered = function (normalgeom) {
...
WebGLVisualiser.prototype.checkTime = function () {
...
WebGLVisualiser.prototype.startAnimation = function (ref) {
...
WebGLVisualiser.prototype.animate = function (ref) {
...
WebGLVisualiser.prototype.makePlumbingPieceBoxes = function (plumb) {
...
WebGLVisualiser.prototype.start_plumbing_view = function () {

    if (this.scene == null) {
        this.pre_init();
    }
    else {
        this.scene.remove(this.plumbingUnits);
        this.scene.remove(this.plumbingPrimals);
        this.scene.remove(this.plumbingDuals);
    ...
    eval(FS.readFile("../circuit.raw.in.adam", { encoding: 'utf8' }));

    var ldata = this.makePlumbingPieceBoxes(plumb);

    var b1 = new THREE.BufferGeometry();
    b1.addAttribute('position', new THREE.BufferAttribute(ldata[0].getAttribute('position').array, 3));
    b1.setIndex(new THREE.BufferAttribute(ldata[0].getIndex().array, 1));
    b1.computeVertexNormals();

    var b2 = new THREE.BufferGeometry();
    b2.addAttribute('position', new THREE.BufferAttribute(ldata[1].getAttribute('position').array, 3));
    b2.setIndex(new THREE.BufferAttribute(ldata[1].getIndex().array, 1));
    b2.computeVertexNormals();

    var b3 = new THREE.BufferGeometry();
    b3.addAttribute('position', new THREE.BufferAttribute(ldata[2].getAttribute('position').array, 3));
    b3.setIndex(new THREE.BufferAttribute(ldata[2].getIndex().array, 1));
    ...
    var primalm = new THREE.MeshLambertMaterial({
        color: 'red',
        side: THREE.DoubleSide,
        shading: THREE.FlatShading, wireframe: false
    });

    var dualm = new THREE.MeshLambertMaterial({
        color: 'blue',
        side: THREE.DoubleSide,
        shading: THREE.FlatShading, wireframe: false
    });

    this.plumbingUnits = new THREE.Mesh(b1, boundingm);
    this.plumbingPrimals = new THREE.Mesh(b2, primalm);
    this.plumbingDuals = new THREE.Mesh(b3, dualm);

    this.scene.add(this.plumbingUnits);
    this.scene.add(this.plumbingPrimals);
    this.scene.add(this.plumbingDuals);

    this.animate(this);
}

WebGLVisualiser.prototype.makeTextSprite2 = function (message) {
...
WebGLVisualiser.prototype.checkboxClick = function (visOptions) {
