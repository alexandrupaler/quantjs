...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'convertft.wast';
  var wasmBinaryFile = 'convertft.wasm';
  var asmjsCodeFile = 'convertft.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_oldconvertft_cpp() } });
...
Module['wasmTableSize'] = 7425;

Module['wasmMaxTableSize'] = 7425;
...
Module["asm"] = asm;
var __GLOBAL__sub_I_oldconvertft_cpp = Module["__GLOBAL__sub_I_oldconvertft_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_oldconvertft_cpp"].apply(null, arguments) };
